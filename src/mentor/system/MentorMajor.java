...
public class MentorMajor extends JFrame{
    ...
    public void mentors(){
        try{
            Conn con = new Conn();
            String query = "select * from major_project;";
    ...
    public MentorMajor(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0,128,128),3,true),"Major-Project",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(0,128,0)));
